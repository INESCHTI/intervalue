...
class FailureTriage(BaseModel):
    """Classification of a failed scenario before any code-change planning."""
    ...
    likely_owner: str = "unassigned"
    recommended_action: str = ""


class FixStep(BaseModel):
    """One human-reviewable step in a proposed fix plan."""
...
class FixPlan(BaseModel):
    """A non-destructive plan for how a developer should fix a failure."""
...
class FailureAnalysis(BaseModel):
    """Triage + fix plan for a failed scenario."""
