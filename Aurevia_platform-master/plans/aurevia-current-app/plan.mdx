...
<Mermaid
  id="system-map"
  caption="Aurevia local runtime and agent mesh."
  source={`flowchart TB
...
<FileTree
  ...
  entries={[
    ...
    },
    {
      ...
      change: "modified",
      note: "Aurevia shell, sidebar navigation, user state, sign out."
    },
    {
...
<Checklist
  ...
  items={[
    ...
    {
      id: "frontend-loads",
      label: "Frontend loads at http://localhost:5173/ with Aurevia title and dev auth.",
      checked: true
    },
    {
      id: "instant-chat",
