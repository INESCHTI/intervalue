...
Endpoints:
  POST /voice/transcribe  â€” STT: audio bytes â†’ transcript (faster-whisper)
  POST /voice/synthesize  â€” TTS: text â†’ audio bytes (Piper)
  POST /voice/chat        â€” Voice-to-voice: audio â†’ transcript â†’ chat â†’ audio
...
# â”€â”€ STT (Speech-to-Text) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
async def transcribe(audio: UploadFile = File(...)) -> dict[str, str]:  # noqa: B008
    """STT endpoint â€” returns text transcript of uploaded audio."""
    audio_bytes = await audio.read()
    transcript = _transcribe_audio(audio_bytes)
    return {"transcript": transcript, "model": _WHISPER_MODEL}


# â”€â”€ TTS (Text-to-Speech) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
async def synthesize(text: str = Form(...)) -> Response:
    """TTS endpoint â€” returns WAV audio bytes for the given text."""
    audio = _synthesize_text(text)
    return Response(content=audio, media_type="audio/wav")


# â”€â”€ Voice-to-Voice â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
async def voice_chat(
    ...
    End-to-end voice-to-voice:
      audio â†’ STT â†’ orchestrator chat â†’ TTS â†’ audio (base64)
    """
    import base64
