...
Ingests PDFs â†’ chunks â†’ embeds â†’ stores in Qdrant.
...
_DOC_STORE: dict[str, str] = {
    "aurora_factsheet": (
        "Aurora Brands â€” Investment Fact Sheet\n"
    ...
    "project_delta": (
        "Project Delta â€” Investment Memo\n"
    ...
    "portfolio_overview": (
        "Meridian Family Office â€” Portfolio Overview 2025\n"
