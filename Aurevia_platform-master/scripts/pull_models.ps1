...
$models = @(
    ...
    "qwen2.5:7b",           # main conversational â€” 4.7 GB
    "llama3.2:3b",          # already pulled, will skip instantly
    "phi3.5",               # US model (Microsoft) â€” ~2.2 GB
    "mistral:7b-instruct",  # French model (Mistral) â€” ~4.1 GB
    "deepseek-r1:7b",       # reasoning model â€” ~4.7 GB  (optional, pull last)
    "nomic-embed-text"      # embeddings â€” already pulled, will skip instantly
)
