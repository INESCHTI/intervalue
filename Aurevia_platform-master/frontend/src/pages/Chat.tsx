...
export default function Chat() {
  ...
  const [messages, setMessages] = useState<UiChatMessage[]>([
    { role: 'assistant', content: 'Hello! I\'m your Aurevia advisor. How can I help you today?' },
  ])
  ...
  async function send(
    ...
    const personaInstruction = `\n\nAdvisor style: You are Aurevia. ${languageInstruction(language)} Do not sign as [Your Name], and do not add email-style signoffs.`
          ...
          <div className={`composer-box ${isListening ? 'composer-box-listening' : ''}`}>
            ...
            <div className="composer-entry">
              ...
              <input
                ...
                placeholder={isListening ? 'Listening...' : 'Ask Aurevia anything'}
                value={input}
  ...
  return (
    <div className={`tool-confirm-card tool-confirm-card-${status}`}>
      ...
      <div className="tool-confirm-body">
        ...
        <h3>{action.label}</h3>
        <p>
          Aurevia is asking permission before it uses this external action.
