...
class ModelRole(str, Enum):
    DEFAULT = "default"  # fast 3B â€” routing, most agents
    CONVERSATIONAL = "conversational"  # 7B â€” financial assistant
    REASONING = "reasoning"  # deepseek-r1 â€” complex analysis
...
class LLMClient:
    ...
    async def stream(self, messages: list[dict[str, str]]) -> AsyncIterator[str]:
        """Streaming chat â€” yields token strings as they arrive."""
