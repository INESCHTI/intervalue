"""
agentkit â€” shared library for the Agentic Mesh.

Public surface:
    A2A protocol  â†’ agentkit.a2a
    MCP tools     â†’ agentkit.mcp
    LLM client    â†’ agentkit.llm
    Tracing       â†’ agentkit.tracing
    Guardrails    â†’ agentkit.guardrails
"""
