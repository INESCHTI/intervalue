"""
Canonical synthetic portfolio â€” the single source of truth for every surface
...
# â”€â”€ Canonical inputs â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

_TARGET_AUM = Decimal("20400000")  # $20.4M assets under management
_TARGET_COST_BASIS = Decimal("12550000")  # AUM âˆ’ cost = $7.85M total profit
NUM_DEALS = 48
INCEPTION = date(2011, 8, 1)  # â‰ˆ14.9y holding period â†’ 7.14% annualized at 178.65% TWR
...
def _build_monthly_returns() -> list[float]:
    ...
    Deterministic monthly HPR series calibrated so the metrics library yields:
      â€¢ ITD TWR            â‰ˆ 178.65%   (cumulative product of (1+r) â‰ˆ 2.7865)
      â€¢ annual volatility  â‰ˆ 12.27%    (monthly std-dev â‰ˆ 3.53%)
    """
    n = 178  # ~14.8 years of monthly observations
    amp = 0.03532  # Â±3.532% monthly swing â†’ â‰ˆ12.27% annualized volatility
...
# Capital calls + a closing NAV distribution, calibrated to IRR â‰ˆ 8%.
...
# Geography allocation (by NAV %) â€” sums to 100.
GEO: dict[str, float] = {
    "Asia": 37.0,
    "North America": 35.0,
    "Global": 16.0,
...
# Sector allocation (by NAV %) â€” sums to 100.
